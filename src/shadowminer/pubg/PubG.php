...
use ShadowMiner\pubg\arena\MapReset;
use ShadowMiner\pubg\commands\pubgCommand;
use ShadowMiner\pubg\math\Vector3;
use ShadowMiner\pubg\provider\YamlDataProvider;

/**
 * Class SkyWars
 * @package skywars
 */
class PubG extends PluginBase implements Listener {
    ...
    public function onEnable() {
        ...
        $this->getServer()->getCommandMap()->register("PubG", $this->commands[] = new PubGCommand($this));
    }
    ...
    public function onChat(PlayerChatEvent $event) {
        ...
        switch ($args[0]) {
            case "help":
                $player->sendMessage("§a> PubG setup help (1/1):\n".
