...
use ShadowMiner\pubg\event\PlayerArenaWinEvent;
use ShadowMiner\pubg\math\Vector3;
...
class Arena implements Listener {
     ...
     */
    public function __construct(PubG $plugin, array $arenaFileData) {
        $this->plugin = $plugin;
    ...
    public function startRestart() {
        ...
        $this->plugin->getServer()->broadcastMessage("§a[PubG] Player {$player->getName()} won the game at {$this->level->getFolderName()}!");
        $this->phase = self::PHASE_RESTART;
    }
    ...
    public static function getChestItems(): array {
        $chestItems = [];
        $chestItems[0] = [
            257, 258, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 279, 259, 368
        ];
        $chestItems[1] = [
            303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 259, 368, 293
        ];
        $chestItems[2] = [
            319, 320, 297, 391, 392, 393, 396, 400, 411, 412, 423, 424, 259, 397:5
        ];
        $chestItems[3] = [
            1, 2, 3, 4, 5, 12, 13, 14, 15, 16, 17, 18, 82, 35, 45, 259, 293
        ];
        $chestItems[4] = [
